...
- Confirm every required CI job, including adversarial protocol, benchmark science, evidence-backed diagnosis, controlled improvement, knowledge and extensions, framework connectors, upstream framework conformance, commercial connector replay, R8 compatibility, and R8 supply chain, passed for the exact revision.
